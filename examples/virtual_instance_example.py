...
d1 = c1.addDocker('d1', ip='10.0.0.251', dimage="manager:latest")
d2 = f1.addDocker('d2', ip='10.0.0.252', dimage="fog:latest")
d3 = e1.addDocker('d3', ip='10.0.0.253', dimage="sensor:latest")
d4 = topo.addDocker('d4', ip='10.0.0.254', dimage="manager:latest")
d5 = e1.addDocker('d5', ip='10.0.0.255', dimage="sensor:latest", resources=PREDEFINED_RESOURCES['medium'])
d6 = e1.addDocker('d6', ip='10.0.0.256', dimage="sensor:latest", resources=PREDEFINED_RESOURCES['large'])
